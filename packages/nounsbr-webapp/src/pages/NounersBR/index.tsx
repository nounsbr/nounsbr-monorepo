...
import classes from './NounersBRPage.module.css';
    ...
    <Section fullWidth={true} className={classes.nounbrersPage}>
      <Col lg={{ span: 6, offset: 3 }}>
        ...
        <Row className={classes.headerRow}>
          <span>
            <Trans>NounersBR</Trans>
          </span>
          <h1>
            <Trans>Welcome, NounerBR!</Trans>
          </h1>
        </Row>
        ...
        <Row className={classes.pictureCard}>
          <Col lg={8} className={classes.treasuryAmtWrapper}>
            ...
            <Row>
              <Col>
                <Trans>
                  So you just won a NounBR.... Cool! Be sure to go over how everything works and
                  head over to our discord server to verify your NounBR!
                </Trans>
              </Col>
            </Row>
          </Col>
        ...
        <Col style={{ textAlign: 'justify' }}>
          <Trans>
            Basic information, major announbrcements, and user verification. If you just bought a
            NounBR, you will need to verify your ownership in the #authentication channel to get
            added to the "NounerBR" role of the server.
          </Trans>
        </Col>
        <br />
        ...
        <Col style={{ textAlign: 'justify' }}>
          <Trans>
            These are channels where only NounsBR DAO members can post. In the spirit of having an
            open and collaborative environment, all of these channels (except for #nounbrer-private)
